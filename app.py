...
Use the Flight Search tool to find flight price data from {origin} to
...
flight options you found. Respond in English unless the destination or
...
"""
        ...
        st.markdown(
            f"""<div class="boarding-pass">
                <div class="bp-topline">
                    <span class="bp-eyebrow">TRIP MANIFEST</span>
                    <span class="bp-route">{origin.upper()} → {destination.upper()}</span>
                </div>
